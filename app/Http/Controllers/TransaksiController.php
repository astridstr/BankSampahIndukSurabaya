...
public function setFormTambahTransaksi(Request $request)
{
    ...
    return redirect()->intended(route('nota.transaksi', $transaksi->id_transaksi));
}

public function notaTransaksi($id_transaksi)
{
    ...
    return view('form.tambah.transaksi-nota', ['nota'=>$nota, 'sampah'=>$sampah, 'total'=>$total]);
}
